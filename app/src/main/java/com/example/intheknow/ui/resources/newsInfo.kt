 ...
 * Use the [newsInfo.newInstance] factory method to
...
class newsInfo : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        var titleText : TextView = view.findViewById(R.id.titleOfNews)
        ...
        titleOfNews.setText(Global.title)
    ...
    companion object {
         ...
         * @return A new instance of fragment newsInfo.
         */
